...
# 전체 모델 목록 (참고용)
analysis_models = {
    "yoojunho": "kata1-b6c96-s1248000-d550347.txt.gz",  # rating 482, (유치원 준호)
    "junho": "kata1-b6c96-s938496-d1208807.txt.gz",  # rating 803, 막 같다 붙이는 애 not bad (준호)
    "yongho": "kata1-b6c96-s1995008-d1329786.txt.gz",  # rating 1069, 막 같다 붙이는 애 (2보단 맥락 있게 둠) not bad (초보 표본) (용호)
    "jaeho": "kata1-b6c96-s5214720-d1690538.txt.gz",  # rating 1599,  (재호)
    "gunho": "kata1-b6c96-s6127360-d1754797.txt.gz",  # rating 1697,  가닥 없음 (건호)
    "mooyaho": "kata1-b6c96-s8080640-d1961030.txt.gz",  # rating 1851,  가닥 약간 (무야호)
